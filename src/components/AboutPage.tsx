      ...
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 md:py-24 lg:px-8">
        ...
        <div className="mt-12">
          ...
          <section className="py-10">
            <h2 className="mb-4 text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">{copy.supportedLanguages}</h2>
            <p className="text-lg leading-8 text-muted-foreground">{copy.supportedLanguagesDescription}</p>
          </section>
        </div>
      </section>
    </main>
