  ...
  return (
    <main id="main-content" tabIndex={-1} className="mx-auto max-w-3xl px-4 py-24 text-center sm:px-6 lg:px-8">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
        <Link href="/" className="min-h-11 bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground">{t('common.goHome')}</Link>
        <Link href="/blog" className="min-h-11 border border-border px-4 py-3 text-sm font-semibold text-primary">{t('common.browseBlog')}</Link>
      </div>
    </main>
  );
}
